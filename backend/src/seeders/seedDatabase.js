...
const products = [
  ...
  {
    name: "Wireless Inventory Tablet",
    sku: "EL-TAB-021",
    category: "Electronics",
    stock: 9,
    minimumStock: 4,
    unit: "pcs",
    price: 2450000,
    description: "Portable tablet for warehouse counting and receiving.",
  },
  {
    ...
    unit: "pcs",
    price: 68000,
    description: "Replacement charging cable for warehouse devices.",
  },
  {
    name: "Document Folder Blue",
    sku: "OF-FLD-017",
    category: "Office Supplies",
    stock: 46,
    minimumStock: 15,
    unit: "pcs",
    price: 12500,
    description: "Archive folder for receiving and purchase documents.",
  },
  {
    ...
    unit: "roll",
    price: 47500,
    description: "Thermal shipping labels for parcel dispatch.",
  },
  {
    ...
    unit: "roll",
    price: 84000,
    description: "Protective wrap for fragile outbound products.",
  },
  {
    name: "Warehouse Cleaning Cloth",
    sku: "MT-CLN-023",
    category: "Maintenance",
    stock: 38,
    minimumStock: 12,
    unit: "pcs",
    price: 9500,
    description: "Reusable cloth for workbench and equipment cleaning.",
  },
];
...
const transactionSeeds = [
  ...
  { sku: "EL-TAB-021", type: "IN", quantity: 4, note: "New counting devices" },
  { sku: "EL-CBL-032", type: "OUT", quantity: 6, note: "Replacement cables" },
  { sku: "OF-FLD-017", type: "IN", quantity: 16, note: "Office replenishment" },
  { sku: "PK-LBL-028", type: "OUT", quantity: 5, note: "Daily dispatch usage" },
  { sku: "PK-BBL-015", type: "OUT", quantity: 2, note: "Fragile shipment usage" },
  { sku: "MT-CLN-023", type: "IN", quantity: 12, note: "Maintenance restock" },
];
